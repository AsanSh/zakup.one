...
class Product(models.Model):
    ...
    price_list = models.ForeignKey('suppliers.PriceList', on_delete=models.SET_NULL, null=True, blank=True, related_name='imported_products', verbose_name='Прайс-лист')
