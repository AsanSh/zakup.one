      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          <div className="flex items-center gap-2 sm:gap-6">
            ...
            <h1 className="text-sm sm:text-base font-bold text-gray-900">ZAKUP.ONE</h1>
            <nav className={`hidden lg:flex gap-0 ${menuOpen ? 'lg:flex' : ''}`}>
              <button
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <span className="text-xs sm:text-sm text-gray-600 truncate max-w-[80px] sm:max-w-none">{user?.email}</span>
            <button
